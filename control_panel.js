...
window.onload = function(){
    ...
    document.querySelector('input#b_save_comment').onclick=function() {ui.hidecomment(true); return false;};
    document.querySelector('input#b_cancel_comment').onclick=function() {ui.hidecomment(false); return false;};
